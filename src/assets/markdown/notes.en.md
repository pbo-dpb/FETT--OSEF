...
The data provided by TBS from federal pay systems details the headcount at the end of each observed month as well as the sum of monthly hours worked for each department in the Core Public Administration and Separate Agencies of the federal public service. Using this data, PBO calculated the average number of FTEs by department, converting the total hours worked into an equivalent number of full-time positions. There may be differences in federal public service staffing data published by the Government of Canada and headcount and FTE counts presented in the tool due to methodological differences (see Comparisons section below).

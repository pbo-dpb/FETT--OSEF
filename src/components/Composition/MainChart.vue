<template>
  <div ref="componentRoot" class="w-full flex flex-col gap-2">
    ...
    <div class="flex xl:flex-row items-center gap-4 justify-end">
      <label
        class="flex gap-2 items-center rounded p-2 bg-slate-100 border-solid w-fit self-end"
      >
        <div
          class="text-stone-700 dark:text-white leading-none pr-2 select-none text-xs font-medium"
        >

  ...
  >
    <RouterLink
      ...
      :class="{
        ...
        'border-transparent hover:border-gray-300 text-gray-500 hover:text-gray-600':
          !tab.selected,
        'text-slate-800 border-slate-600  -mb-0.25 border-b-3 pb-2.25':
          tab.selected,
      }"
...
const tabs = computed(() => {
  return [
    ...
    },
    {
      ...
      to: {
        name: "departments",
        params: { departments: previouslySelectedDepartmentIds.value },
      },

<template>
    <ToggleGroupRoot v-model="preferredTimeframe" type="single" class="flex flex-row gap-2">
        <ToggleGroupItem value="1Y" :class="toggleGroupItemClasses" :disabled="preferredTimeframe === '1Y'">
            {{ strings.preferred_timeframe_1y }}
        </ToggleGroupItem>
        <ToggleGroupItem value="3Y" :class="toggleGroupItemClasses" :disabled="preferredTimeframe === '3Y'">
